...
<?php include 'header/header.php'; ?>
  ...
  <?php
    ...
    {
			echo "<h3>Your Complaint for Hostel has been registered!</h3>";
      $query1 = "SELECT Name FROM student where roll_no='$roll_no'";
      $query2 = "SELECT Cmpl_ID,Date,Status FROM complaints where Date=NOW()";
      $query3 = "SELECT HName,Floor_No,Room_No FROM live inner join hostel on live.Room_Loc=hostel.Room_Loc where live.roll_no='$roll_no'";
      echo " <br> <br>";
